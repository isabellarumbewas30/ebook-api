...
class AuthorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'success' => 201,
            'message' => 'wow tersimpan!! congrats',
            'data' => $table
        ], 201);
    }
    ...
    public function show($id)
    {
        ...
        if ($author) {
            ...
            return response()->json([
                'status' => 404,
                'message' => 'id atas' . $id . 'ngga ada, coba diteliti lagi'
            ], 404);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($author){
            ...
            return response()->json([
                'status'=>404,
                'message'=> $id . 'ngga ada, coba diteliti lagi'
            ], 404);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if($author){
            ...
            return response()->json([
                'status' => 404,
                'message' => 'id' . $id . 'ngga ada, coba diteliti lagi'            
            ], 404);
        }
    }
}